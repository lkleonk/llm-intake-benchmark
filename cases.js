...
window.BENCHMARK = {
  intro: {
    ...
    lead: {
      de: "Manuelles Evaluations-Tool für den Lumee-Aufnahme-Chatbot. Jede simulierte Nutzereingabe (SU) wird im echten Chat ausgeführt; das Ergebnis wird hier eingetragen und bewertet.",
      en: "Manual evaluation harness for the Lumee intake chatbot. Each simulated-user (SU) prompt is run in the real chat; the result is recorded and judged here.",
    },
    bullets: {
      de: [
        "SU-Eingabe kopieren → im echten Lumee-Chat ausführen → AI-Antwort und/oder Extractor-JSON hier einfügen.",
      ...
      en: [
        "Copy an SU prompt → run it in the real Lumee chat → paste the AI answer and/or Extractor JSON here.",
