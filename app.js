/* Lumee benchmark harness — state, rendering, autosave, print. */
(function () {
  "use strict";

  var META_KEY = "lumee_bench_meta_v1";
  var RESULTS_KEY = "lumee_bench_results_v1";
  ...
  function getResult(id) {
    if (!results[id]) results[id] = { ai: "", extractor: "", verdict: null, notes: "", frozen: false };
    return results[id];
  }
  ...
  // ---------- header collapse ----------
  var HEADER_KEY = "lumee_bench_header_collapsed_v1";
  ...
  document.getElementById("btn-export").addEventListener("click", function () {
    ...
    a.href = url;
    a.download = "lumee-benchmark-" + (meta.date || today()) + ".json";
    a.click();
